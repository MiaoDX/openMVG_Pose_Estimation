...
//        cout << "The refined answers:" << endl;
    ...
    Eigen::Map<Eigen::MatrixXd> ( rotation_vec.data (), 3, 3 ) = pose.rotation ().transpose();
    std::vector<double> translation_vec{ pose.translation ()( 0 ) , pose.translation () ( 1 ), pose.translation () ( 2 ) };
